...
// lookup product query — single product by id
// description is a full string here (not shortDescription)
export type GqlLookupProduct = {
  __typename: string;
  id?: string | null;
  title?: string | null;
...
export type GqlLookupResponse = {
  product?: GqlLookupProduct | null;
};
